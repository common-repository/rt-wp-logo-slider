...
if(!class_exists('rtWLS')){
	 ...
	 * @property string controllersPath
	...
	class rtWLS
	{
		...
		function __construct() {
			...
			$this->options = array(
				'settings' => 'wpl_sp_settings',
				'version' => '1.0',
				'installed_version' => 'wpl_sp_current_version'
			);
			$this->defaultSettings = array(
				'custom_css' =>null
			);

			$this->post_type = "wpl_sp";
			...
			$this->assetsUrl = WPL_SP_PLUGIN_URL . '/assets/';
